...
const bgColor = document.getElementById("chooseColor").value;
const userTxt = document.getElementById("userTxt").value;
const color = document.getElementById("chooseTxtColor").value;
const divAlert = document.getElementById("danger");
const alertPara = document.getElementById("alertPara");
...
const underline = document.getElementById("unline");
bold.onchange = () => {
   switch (bold.checked) {
      case true:
